...
public class FeedRecord extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardCattle.setOnClickListener(click -> {
            startActivity(new Intent(this, FeedStockDetailsActivity.class).putExtra(Constant.ANIMAL, Constant.COWBULL));
        });
        cardGoat.setOnClickListener(click -> {
            startActivity(new Intent(this, FeedStockDetailsActivity.class).putExtra(Constant.ANIMAL, Constant.GOAT));
        });
        cardSheep.setOnClickListener(click -> {
            startActivity(new Intent(this, FeedStockDetailsActivity.class).putExtra(Constant.ANIMAL, Constant.SHEEP));
        });
    }
